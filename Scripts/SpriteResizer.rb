...
class ScreenBorder
  ...
  def initializeInternal
    ...
    @defaultwidth = DEFAULTSCREENWIDTH + 2 * BORDERWIDTH
    @defaultheight = DEFAULTSCREENHEIGHT + 2 * BORDERHEIGHT
  ...
  def refresh
    ...
    @defaultbitmap.fill_rect(0, 0, @defaultwidth, $ResizeOffsetY, black)
    @defaultbitmap.fill_rect(0, $ResizeOffsetY, $ResizeOffsetX, @defaultheight - $ResizeOffsetY, black)
    @defaultbitmap.fill_rect(@defaultwidth - $ResizeOffsetX, $ResizeOffsetY, $ResizeOffsetX, @defaultheight - $ResizeOffsetY, black)
    @defaultbitmap.fill_rect($ResizeOffsetX, @defaultheight - $ResizeOffsetY, @defaultwidth - $ResizeOffsetX * 2, $ResizeOffsetY, black)
  end
